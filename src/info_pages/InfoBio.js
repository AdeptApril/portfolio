    ...
    render() {
        return (
            <div className="info-div">
                ...
                <p>When needed, she picks up languages and tools to fit a project, whether it's learning to use Webstorm, using Python to make toy programs for BBSs, or soldering, wiring, filming, or video editing as an embedded systems instructor at BlueStamp.</p>
